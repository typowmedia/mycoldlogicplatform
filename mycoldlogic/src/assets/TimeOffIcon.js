...
const TimeOffIcon = props => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink" width={this.props.width} height={this.props.height} viewBox="0 0 125 125" aria-labelledby="title">
            ...
            <g id="timeoffsvg" style="fill:#0D3C55;" clipPath="url(#b)">
                <path
